...
@PageTitle("Производители оборудования")
...
public class CompanyListView extends VerticalLayout {
  ...
  public void configureGrid() {
    ...
    companyGrid.addColumn(Company::getName).setHeader("Наименование компании");
    ...
    companyGrid.asSingleSelect().addValueChangeListener(event -> editCompany(event.getValue()));
  }
